 ...
 return (
  ...
  <h2 className="text-center">Register</h2>
   ...
   <div className ="form-group">
            ...
            <textarea className="form-control" type = "password" name="password2" onChange = {this.onChange} value = {password2} />
            </div>


        <div className ="form-group">
        <button className="btn btn-primary" type = "submit" >Register</button> </div>
